...
use crate::schema::{Hand as SchemaHand, NormalizedGame};
use crate::types::{BoardData, ContractResult, ParsedContract, SeatPlayers};
...
pub(crate) fn convert_deal(deal: &crate::schema::Deal) -> Option<Deal> {
